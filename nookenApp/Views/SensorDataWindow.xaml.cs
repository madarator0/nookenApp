...
namespace nookenApp.Views
{
    public partial class SensorDataWindow : Window
    {
        ...
        {
            InitializeComponent();
            Loaded += SensorDataWindow_Loaded; // Attach event handler for Loaded event
        }

        private async void SensorDataWindow_Loaded(object sender, RoutedEventArgs e)
        {
            await InitializeDatabaseAsync();
            _viewModel = new SensorDataViewModel(_dbContext);
        ...
        {
            _viewModel.UpdateAPI();  // Assuming UpdateAPI is now an instance method
        }
    }
}
